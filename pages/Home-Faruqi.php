...
if (isset($_SESSION["login"])) {
  ...
  $result_login = mysqli_query($connuser, "SELECT * FROM user_faruqi WHERE email = '$login_as'");
  ...
  <nav class="navbar navbar-expand navbar-dark bg-<?= isset($_COOKIE["warna_navbar"])  ? $_COOKIE["warna_navbar"] : "success"; ?>">
    <div class="container py-2">
      <?php if (isset($_SESSION["login"])) : ?>
        ...
        <div class="d-flex">
          <a href="pages/Add-Faruqi.php" class="btn btn-light text-<?= isset($_COOKIE["warna_navbar"])  ? $_COOKIE["warna_navbar"] : "success"; ?>" role="button">Add Car</a>
          <div class="dropdown ms-4">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item text-<?= isset($_COOKIE["warna_navbar"])  ? $_COOKIE["warna_navbar"] : "success"; ?>" href="pages/Profile-Faruqi.php">Profile</a></li>
      ...
      <?php else : ?>
        <div class="navbar-nav w-100 d-flex justify-content-between">
          ...
          <a class="nav-link" href="pages/Login-Faruqi.php">Login</a>
        </div>
      <?php endif; ?>
    </div>
  </nav>
      ...
      <div class="d-flex gap-5 wrap justify-content-center align-items-center">
        <div>
          ...
          <div class="d-flex  justify-content-lg-start mt-2">
            <a class="btn btn-<?= isset($_COOKIE["warna_navbar"])  ? $_COOKIE["warna_navbar"] : "primary"; ?> px-4 button" href="pages/<?= isset($_SESSION["login"]) ? "List-Faruqi.php" : "Login-Faruqi.php"; ?>" role="button">MyCar</a>
          </div>
