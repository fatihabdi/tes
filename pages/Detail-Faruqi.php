...
$sql = "SELECT * FROM showroomead_faruqi WHERE id_mobil = $id";
...
<head>
  ...
  <title>Detail Car | Faruqi_1202204105</title>
        ...
        echo "
                ...
                <div class='d-flex justify-content-center align-items-start gap-5 mt-5'>
                  ...
                  <form action='' enctype='multipart/form-data'>
                    ...
                    <a href='Edit-Faruqi.php?id=" . $getDetail["id_mobil"] . "' class='btn btn-success' style='margin-top: 40px;'>Edit</a>
                  </form>
                </div>
            ";
      }
