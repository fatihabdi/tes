...
<head>
  ...
  <title>List Car | Faruqi_1202204105</title>
  ...
  <nav class="navbar navbar-expand navbar-dark bg-<?= isset($_COOKIE["warna_navbar"])  ? $_COOKIE["warna_navbar"] : "success"; ?>">
    <div class="container">
      <div class="collapse navbar-collapse d-flex justify-content-between" id="navbarNavAltMarkup">
        ...
        <div class="d-flex">
          <a href="Add-Faruqi.php" class="btn btn-light text-<?= isset($_COOKIE["warna_navbar"])  ? $_COOKIE["warna_navbar"] : "success"; ?>" role="button">Add Car</a>
          <div class="dropdown ms-4">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item text-<?= isset($_COOKIE["warna_navbar"])  ? $_COOKIE["warna_navbar"] : "success"; ?>" href="Profile-Faruqi.php">Profile</a></li>
        ...
        <div class="d-flex gap-5">
          ...
          if (mysqli_num_rows($result) > 0) {
            ...
            <div class='card-body'>
              ...
              <span class='d-flex'>
                <a href='Detail-Faruqi.php?id=" . $row["id_mobil"] . "' class='btn btn-success' style='border-radius: 100px; width:140px; height: 36px;'>Detail</a>
